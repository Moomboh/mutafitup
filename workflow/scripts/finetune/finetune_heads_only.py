...
from mutafitup.train.train_multitask_model import train_multitask_heads_only
...
embedding_cache_dir = snakemake.params["embedding_cache_dir"]
...
logger.info("Start training (MultitaskModel heads_only)")
...
model, history, best_checkpoints = train_multitask_heads_only(
    model=model,
    tokenizer=tokenizer,
...
logger.info("Training complete (MultitaskModel heads_only)")
